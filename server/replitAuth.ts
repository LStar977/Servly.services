...
export function getSession() {
  ...
  return session({
    ...
    cookie: {
      ...
      sameSite: 'lax', // Allow OAuth callback while protecting against CSRF
      maxAge: sessionTtl,
    },
  });
}
...
async function upsertUser(claims: any, role: string = 'customer') {
...
export const isAuthenticated: RequestHandler = async (req, res, next) => {
  ...
  // For local/email-password users, just check if they have an ID
